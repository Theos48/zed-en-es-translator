...
| FR-019-FR-020; SC-001-SC-009, SC-011 | Four real service/surface rows and real negative/offline/rollback evidence | T056 partial: local CLI/direct Zed, offline/failed-update/rollback, six pre-contact negatives and real rejected-credential control pass; Azure success and remaining rows pending |
