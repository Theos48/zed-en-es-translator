...
| `speckit-implement` | automatic scope complete through convergence T062; T056 partial | TDD implementation and all automatic Rust/shell/security/supply-chain gates pass; approved real local CLI/offline/idempotency/rollback and pre-contact negatives pass, while direct Zed, Azure real, failed-update, clean and literal clean-checkout evidence remain pending |
